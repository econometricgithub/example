...
def linerity(df_data):
    ...
    plt.savefig("D:/Kyaw Thet/Thesis/MainProject/static/linearity1.png", dpi=72)
# Homoscedasticity
def homoscedasticity(y, results):
    ...
    #plt.show()
    plt.savefig("D:/Kyaw Thet/Thesis/MainProject/static/homoscedasticity.png", dpi=72)
...
def normality(y, results):
    ...
    #plt.show()
    plt.savefig("D:/Kyaw Thet/Thesis/MainProject/static/normality.png", dpi = 72)
